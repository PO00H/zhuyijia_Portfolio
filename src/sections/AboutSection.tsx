...
const educationData: TimelineItem[] = [
  {
    ...
    title: '北京林业大学',
    subtitle: '交互设计(硕士)',
    description: '人机交互（HCI）理论、3D 空间内的用户体验设计、虚拟现实（VR/AR）交互机制、游戏机制与玩家反馈回路研究。',
  },
  {
    period: '21.09 — 25.06',
    title: '浙江农林大学',
    subtitle: '家具设计与工程(本科)',
    description: '通过工程力学与人体工学课程，建立了严谨的物理常识与空间几何认知。',
  },
  {
    period: '21.09 — 23.09',
    title: '浙江农林大学',
...
const experienceData: TimelineItem[] = [
  ...
  },
  {
    ...
    subtitle: '游戏交互实习生',
    description:
      '游戏交互系统与 UX 调研：深入参与游戏产品的交互体验调研，协助设计针对玩家行为链路与操作习惯的测试方案，收集并量化分析玩家反馈数据，梳理核心操作痛点与游戏机制反馈回路；竞品拆解与逻辑优化：独立撰写多份竞品分析报告，深度拆解市面主流游戏的核心交互系统，为研发团队优化交互逻辑与界面表现提供详实的数据支撑与迭代建议。',
  },
  {
    period: '24.02 — 24.04',
    title: '温州澳珀家俱有限公司',
    subtitle: '产品交互实习生',
    description:
      '高精度 3D 建模与空间解析：运用 CAD、Maya、Blender 等专业软件，严格遵循工业级工程制图规范，完成复杂零部件的高精度三维建模与二维工程图纸绘制。',
  },
  {
    period: '23.07 — 23.09',
